...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 19, 2019 at 07:27 PM
...
(18, 'Shaukat Iqbal', 'shaukat.iqbal3001@gmail.com', '1234', '81dc9bdb52d04dc20036dbd8313ed055');
...
(3, 'who is pm of pak', 'ik', 'ns', 'hamza', 'shaukat', 1);
...
INSERT INTO `results` (`student_id`, `test_id`, `marks`) VALUES
(13, 2, 2),
(14, 2, 1),
(15, 2, 1);
...
INSERT INTO `tests` (`test_id`, `test_date`) VALUES
(2, '2019-06-17 02:00:00');
...
ALTER TABLE `enrolledstudents`
  ADD CONSTRAINT `fk_enrolledStudents_students1` FOREIGN KEY (`students_cnic`) REFERENCES `students` (`cnic`),
  ADD CONSTRAINT `fk_enrolledStudents_tests1` FOREIGN KEY (`test_id`) REFERENCES `tests` (`test_id`);

--
-- Constraints for table `papers`
--
ALTER TABLE `papers`
  ADD CONSTRAINT `fk_papers_questions1` FOREIGN KEY (`question_id`) REFERENCES `questions` (`question_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_papers_tests1` FOREIGN KEY (`test_id`) REFERENCES `tests` (`test_id`) ON UPDATE CASCADE;

--
-- Constraints for table `questions`
--
ALTER TABLE `questions`
  ADD CONSTRAINT `fk_questions_subjects` FOREIGN KEY (`subject_id`) REFERENCES `subjects` (`subject_id`);
